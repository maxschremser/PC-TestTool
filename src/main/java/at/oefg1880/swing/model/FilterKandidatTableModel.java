...
public class FilterKandidatTableModel extends KandidatTableModel {
  ...
  public FilterKandidatTableModel(final FilterKandidatTable filterKandidatTable, ArrayList<Kandidat> items) {
    super();
...
//      Kandidat k = filterItems.get(0);
//      filterKandidatTable.setKandidat(k);
//      filterKandidatTable.getFilterField().setText(k.getTitleAndName());
//    }
