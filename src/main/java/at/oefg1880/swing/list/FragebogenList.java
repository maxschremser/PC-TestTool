...
public class FragebogenList extends JList implements ActionListener, IConfig {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() == 2 && SwingUtilities.isLeftMouseButton(e)) {
                    frame.getFragebogenPane().createNewAntwortDialog((Fragebogen) getSelectedValue());
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (key == KeyEvent.VK_ENTER) {            // handle enter key pressed
                    ...
                    frame.getFragebogenPane().createNewFragebogenDialog();
                } else if (key == KeyEvent.VK_S) {
                    if (frame.getFragebogenPane().getSpeichernButton().isEnabled())
                        frame.exportData();
                } else if (key == KeyEvent.VK_DELETE) {
                    String title = ((Fragebogen) getSelectedValue()).getTitle();
                    int n = frame.showDeleteFragebogenDialog(frame.getFragebogenPane().getFragebogenList(), "Wirklich '" + title + "' löschen ?", "Löschen");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == menuEdit) {
            frame.getFragebogenPane().editFragebogenDialog((Fragebogen) getSelectedValue());
            ...
            if (n == 0) // JA
                model.remove(getSelectedIndex());
            if (model.getSize() <= 0)
                frame.getFragebogenPane().getSpeichernButton().setEnabled(false);
