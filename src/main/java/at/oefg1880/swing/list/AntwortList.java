 ...
 */
public class AntwortList extends JList implements ActionListener {
    GradientPanel cell;
...
//    menu.add(new JPopupMenu.Separator());
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (key == KeyEvent.VK_ENTER) {            // handle enter key pressed
                    ...
                    int n = frame.showDeleteFragebogenDialog(frame.getFragebogenPane().getAntwortDialog(), "Wirklich '" + title + "' löschen ?", "Löschen");
    ...
    private void createEditAntwortDialog(Antwort antwort) {
        dialog = new AntwortDialog(frame, "Antworten bearbeiten ...", fragebogen, antwort);
